        ...
        <div className="cavani_tm_all_wrap" data-magic-cursor="show" data-enter="fadeInUp" data-exit="">
          ...
          <div className="cavani_tm_mainpart">
            ...
            <div className="main_content">
                        ...
                        <div className="programming">
                          ...
                          <div className="cavani_progress">
                            <div className="progress_inner" data-value="95">
                              <span><span className="label">HTML &amp; CSS</span><span className="number">95%</span></span>
                              <div className="background"><div className="bar"><div className="bar_in"></div></div></div>
                            </div>
                            <div className="progress_inner" data-value="80" >
                              <span><span className="label">JavaScript</span><span className="number">80%</span></span>
                              <div className="background"><div className="bar"><div className="bar_in"></div></div></div>
                            </div>
                            <div className="progress_inner" data-value="90">
                              <span><span className="label">WordPress</span><span className="number">90%</span></span>
                              <div className="background"><div className="bar"><div className="bar_in"></div></div></div>
                            </div>
                          </div>
                        </div>
                            ...
                            <ul>
                              <li>
                                <div className="list_inner">
                                  <div className="myCircle" data-value="0.95"></div>
                                  <div className="title"><span>English</span></div>
                                </div>
                              </li>
                              <li>
                                <div className="list_inner">
                                  <div className="myCircle" data-value="0.8"></div>
                                  <div className="title"><span>Russian</span></div>
                                </div>
                              </li>
                              <li>
                                <div className="list_inner">
                                  <div className="myCircle" data-value="0.9"></div>
                                  <div className="title"><span>Arabic</span></div>
                                </div>
                              </li>
                            </ul>
                          </div>
                        ...
                        <ul className="owl-carousel">
                          <li>
                            <div className="list_inner">
                              ...
                              <div className="details">
                                <div className="image">
                                  <div className="main" data-img-url="img/testimonials/1.jpg"></div>
                                </div>
                                <div className="info">
                          ...
                          <li>
                            <div className="list_inner">
                              ...
                              <div className="details">
                                <div className="image">
                                  <div className="main" data-img-url="img/testimonials/2.jpg"></div>
                                </div>
                                <div className="info">
                          ...
                          <li>
                            <div className="list_inner">
                              ...
                              <div className="details">
                                <div className="image">
                                  <div className="main" data-img-url="img/testimonials/3.jpg"></div>
                                </div>
                                <div className="info">
                        ...
                        <li className="vimeo">
                          <div className="list_inner">
                            <div className="image">
                              ...
                              <a className="cavani_tm_full_link popup-vimeo" href="https://vimeo.com/337293658"></a>
                            </div>
                          </div>
                        </li>
                        ...
                        <li className="image">
                          <div className="list_inner">
                            <div className="image">
                              ...
                              <a className="cavani_tm_full_link zoom" href="img/portfolio/4.jpg"></a>
                            </div>
                          </div>
                        </li>
                        <li className="image">
                          <div className="list_inner">
                            <div className="image">
                              ...
                              <a className="cavani_tm_full_link zoom" href="img/portfolio/5.jpg"></a>
                            </div>
                          </div>
                        </li>
                        <li className="detail">
              ...
              <div className="cavani_tm_section" id="service">
                <div className="section_inner">
                  <div className="cavani_tm_service">
                    ...
                    <div className="service_list">
                      <ul>
                        <li>
                          <div className="list_inner">
                            <img className="svg" src="img/svg/3d.svg" alt="" />
                            <h3 className="title">3D Animation</h3>
                            <p className="text">Developing website involves creating your website, making it one of the most vital parts of your marketing</p>
                            <a className="cavani_tm_full_link" href="#"></a>

                            <img className="popup_service_image" src="img/news/1.jpg" alt="" />
                        ...
                        <li>
                          <div className="list_inner">
                            ...
                            <h3 className="title">Explainer Videos</h3>
                            <p className="text">Developing website involves creating your website, making it one of the most vital parts of your marketin</p>
                            <a className="cavani_tm_full_link" href="#"></a>

                            <img className="popup_service_image" src="img/news/2.jpg" alt="" />
                            <div className="service_hidden_details">
                              <div className="service_popup_informations">
                                <div className="descriptions">
                                  <p>Cavani is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
                        ...
                        <li>
                          <div className="list_inner">
                            <img className="svg" src="img/svg/character.svg" alt="" />
                            <h3 className="title">App Development</h3>
                            <p className="text">Developing website involves creating your website, making it one of the most vital parts of your marketing</p>
                            <a className="cavani_tm_full_link" href="#"></a>

                            <img className="popup_service_image" src="img/news/3.jpg" alt="" />
                            <div className="service_hidden_details">
                              <div className="service_popup_informations">
                                <div className="descriptions">
                                  <p>Cavani is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
                        ...
                        <li>
                          <div className="list_inner">
                            <img className="svg" src="img/svg/edu.svg" alt="" />
                            <h3 className="title">Educational Video</h3>
                            <p className="text">Developing website involves creating your website, making it one of the most vital parts of your marketing</p>
                            <a className="cavani_tm_full_link" href="#"></a>

                            <img className="popup_service_image" src="img/news/4.jpg" alt="" />
                            <div className="service_hidden_details">
                              <div className="service_popup_informations">
                                <div className="descriptions">
                                  <p>Cavani is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
                        ...
                        <li>
                          <div className="list_inner">
                            <img className="svg" src="img/svg/art.svg" alt="" />
                            <h3 className="title">3D Game Art</h3>
                            <p className="text">Developing website involves creating your website, making it one of the most vital parts of your marketing</p>
                            <a className="cavani_tm_full_link" href="#"></a>

                            <img className="popup_service_image" src="img/news/5.jpg" alt="" />
                            <div className="service_hidden_details">
                              <div className="service_popup_informations">
                                <div className="descriptions">
                                  <p>Cavani is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
                        ...
                        <li>
                          <div className="list_inner">
                            <img className="svg" src="img/svg/presentation.svg" alt="" />
                            <h3 className="title">Presentations</h3>
                            <p className="text">Developing website involves creating your website, making it one of the most vital parts of your marketing</p>
                            <a className="cavani_tm_full_link" href="#"></a>

                            <img className="popup_service_image" src="img/news/6.jpg" alt="" />
                            <div className="service_hidden_details">
                              <div className="service_popup_informations">
                                <div className="descriptions">
                                  <p>Cavani is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
              ...
              <div className="cavani_tm_section" id="news">
                <div className="section_inner">
                  <div className="cavani_tm_news">
                    ...
                    <div className="news_list">
                      <ul>
                        <li data-img="img/news/1.jpg">
                          <div className="list_inner">
                            <span className="number">01</span>
                            <div className="details">
                              <div className="extra_metas">
                                <ul>
                                  <li><span>July 07, 2022</span></li>
                                  <li><span><a href="#">Branding</a></span></li>
                                  <li><span><a href="#">0 Comments</a></span></li>
                                </ul>
                              </div>
                              <div className="post_title">
                                <h3><a href="#">Reasons Why People Use Discord</a></h3>
                              </div>
                            </div>
                        ...
                        <li data-img="img/news/2.jpg">
                          <div className="list_inner">
                            <span className="number">02</span>
                            <div className="details">
                              <div className="extra_metas">
                                <ul>
                                  <li><span>July 02, 2022</span></li>
                                  <li><span><a href="#">Design</a></span></li>
                                  <li><span><a href="#">2 Comments</a></span></li>
                                </ul>
                              </div>
                              <div className="post_title">
                        ...
                        <li data-img="img/news/3.jpg">
                          <div className="list_inner">
                            <span className="number">03</span>
                            <div className="details">
                              <div className="extra_metas">
                                <ul>
                                  <li><span>June 30, 2022</span></li>
                                  <li><span><a href="#">Lifestyle</a></span></li>
                                  <li><span><a href="#">5 Comments</a></span></li>
                                </ul>
                              </div>
                              <div className="post_title">
                                <h3><a href="#">A Final Farewell to the iPod</a></h3>
                              </div>
                            </div>
                        ...
                        <li data-img="img/news/4.jpg">
                          <div className="list_inner">
                            <span className="number">04</span>
                            <div className="details">
                              <div className="extra_metas">
                                <ul>
                                  <li><span>June 25, 2022</span></li>
                                  <li><span><a href="#">Branding</a></span></li>
                                  <li><span><a href="#">0 Comments</a></span></li>
                                </ul>
                              </div>
                        ...
                        <li data-img="img/news/5.jpg">
                          <div className="list_inner">
                            <span className="number">05</span>
                            <div className="details">
                              <div className="extra_metas">
                                <ul>
                                  <li><span>June 20, 2022</span></li>
                                  <li><span><a href="#">Design</a></span></li>
                                  <li><span><a href="#">1 Comment</a></span></li>
                                </ul>
                              </div>
                              <div className="post_title">
                                <h3><a href="#">How to Take a Break from Yourself</a></h3>
                              </div>
                            </div>
                        ...
                        <li data-img="img/news/6.jpg">
                          <div className="list_inner">
                            <span className="number">06</span>
                            <div className="details">
                              <div className="extra_metas">
                                <ul>
                                  <li><span>June 11, 2022</span></li>
                                  <li><span><a href="#">Media</a></span></li>
                                  <li><span><a href="#">2 Comments</a></span></li>
                                </ul>
                              </div>
                              <div className="post_title">
                                <h3><a href="#">The Age of Extinction Is Here</a></h3>
                              </div>
                            </div>
